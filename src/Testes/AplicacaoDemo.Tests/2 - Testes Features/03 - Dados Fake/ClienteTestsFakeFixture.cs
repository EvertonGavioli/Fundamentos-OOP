...
{
    [CollectionDefinition(nameof(ClienteFakeCollection))]
    public class ClienteFakeCollection : ICollectionFixture<ClienteTestsFakeFixture>
    { }

    public class ClienteTestsFakeFixture : IDisposable
    {
